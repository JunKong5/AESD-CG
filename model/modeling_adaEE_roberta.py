...
from .modeling_adaEE_bert import BertModel, BertPreTrainedModel, entropy,  EElayerException,ATTGTeaKDLoss
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None,
        ...
        if labels is not None:
            for EElayer_exit  in outputs[-1]:
                highway_logits = EElayer_exit[0]
                eachlayer_logits_all.append(highway_logits)
                if not self.training:
